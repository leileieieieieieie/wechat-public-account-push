export const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx8be0c2a75ebf54af",
  
  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "c6b1a5357f5d97a5a8adf1f8fc36dc68",
  ...
  USERS: [
    {
      ...
      id: "oo1mC6pjEw_94eTHapqS1VViucxM",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "iUM_pQxEHPrY2hLRBf66NUluUhwdL7LqdzMuWSIqn0A",
      // 所在省份
      province: "山东",
      // 所在城市
      city: "青岛",
      ...
      customizedDateList: [
        // 在一起的日子
        {"keyword": "love_day", date: "2020-5-27"},
    },
    {
      name: "老婆1",
      id: "",
